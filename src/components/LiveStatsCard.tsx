...
// LiveStatsCard is a child of RecordTab which re-renders at 60fps (due to volume state)
// Memoizing prevents unnecessary re-renders since props only change when a snore event ends
