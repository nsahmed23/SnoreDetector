...
// Memoized because it is a child of RecordTab (which re-renders 60fps with volume changes),
// but the stats it displays update very infrequently (only when a snore event ends).
