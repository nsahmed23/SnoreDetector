      ...
      navigator.mediaDevices.getUserMedia({ audio: true })
        .then((stream) => {
          ...
          const updateVolume = () => {
            ...
            // Merged multiple iterations over dataArray (sum calculation + low/high freq split)
            // into a single pass to reduce overhead in the 60fps requestAnimationFrame loop.
            let sum = 0;
            let lowFreqSum = 0;
            let highFreqSum = 0;
