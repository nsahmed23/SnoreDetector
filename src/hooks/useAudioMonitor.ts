      ...
      navigator.mediaDevices.getUserMedia({ audio: true })
        .then((stream) => {
          ...
          const updateVolume = () => {
            ...
            // Loop fusion: compute total sum and frequency distribution in a single pass
            // This is critical for performance as it runs at 60fps in requestAnimationFrame
