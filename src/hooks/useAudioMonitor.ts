      ...
      navigator.mediaDevices.getUserMedia({ audio: true })
        .then((stream) => {
          ...
          const updateVolume = () => {
            ...
            // Apply loop fusion: calculate sum, lowFreqSum, and highFreqSum in a single pass over dataArray
            // to improve performance inside the 60fps requestAnimationFrame loop.
            let sum = 0;
            let lowFreqSum = 0;
            let highFreqSum = 0;
