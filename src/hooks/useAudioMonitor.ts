...
export function useAudioMonitor(
  ...
  // Ref to track snoring state synchronously without causing re-renders/teardowns
      ...
      navigator.mediaDevices.getUserMedia({ audio: true })
        .then((stream) => {
          ...
          const updateVolume = () => {
            ...
            // Fused loop: calculate sum and heuristic frequency distributions in a single pass
            // to avoid redundant iterations at 60fps.
            let sum = 0;
            let lowFreqSum = 0;
            let highFreqSum = 0;
