      ...
      navigator.mediaDevices.getUserMedia({ audio: true })
        .then((stream) => {
          ...
          const updateVolume = () => {
            ...
            // Combine total sum and frequency separation into a single pass over dataArray
            // to reduce redundant iterations inside the 60fps requestAnimationFrame cycle.
