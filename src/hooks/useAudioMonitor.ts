...
export function useAudioMonitor(
      ...
      navigator.mediaDevices.getUserMedia({ audio: true })
        .then((stream) => {
          ...
          const updateVolume = () => {
            ...
            // Apply loop fusion to calculate sum, low frequency, and high frequency in a single pass
            // This prevents redundant array iterations in the 60fps loop
  ...
  }, [isTracking, thresholdDB, sensitivity]); // Removed isCurrentlySnoring to prevent audio stream teardown
